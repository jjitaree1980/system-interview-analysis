...
|-----|--------|----------|-----------------------|
| Limited access vs. intentional control | Idus | HIGH | UNCLEAR - needs validation of intent |
| SAP integration broken | Idus | HIGH (if confirmed) | Unknown - needs Rusal IT & vendor assessment |
