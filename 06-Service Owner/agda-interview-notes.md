...
**Your department/team:** HR

---

## SECTION 1: SYSTEM OVERVIEW

**System name:** Agda/Viska

**Number of active users:** ca 400-450

**Who currently manages this system day-to-day?**
Helena

**Who else is involved in managing this system?**
Currently is only Helena; the new colleauge would join in Mars 2026
...
Check ONE box:
- [x] Cloud/SaaS - Vendor manages everything (we access through web browser)
...
### Vendor information
- **Vendor/product name:** Visma
- **Do we have a support contract?** Not sure
...
| Activity | Hours per week | Examples/notes |
|----------|----------------|----------------|
| **Creating/removing user accounts** | 0.1 | Setting up new users, removing when people leave |
| **Password resets** | 0.1 | Helping users who forgot passwords |
| **Changing user permissions** | 0.1 | Adjusting what users can access/do |

**Subtotal - User Management:** 0.3 hours/week
...
| Activity | Hours per week | Examples/notes |
|----------|----------------|----------------|
| **Technical support** | 0.1 | Can't log in, error messages, system slow/down |
| **Business support** | 0.1 | "How do I...", process questions, how to use features |

**Subtotal - User Support:** 0.2 hours/week
...
| Activity | Hours per week | Examples/notes |
|----------|----------------|----------------|
| **Vendor coordination** | 0.12 | Contacting vendor for support, meetings with vendor |
| **Meetings about this system** | 0 | Regular meetings, planning meetings |
| **Other (please specify):** | _____ | |
| _____ | _____ | |

**Subtotal - Other:** 0.12 hours/week
...
- **Purely technical skills** (IT knowledge, not business knowledge): 0%
...
- **Mixed** (both technical and business knowledge needed): 0%
...
### Creating New Users
- **New user accounts per month:** 3-5
- **Time per account (technical setup):** 5-10 minutes
- **Who decides what access level new users need?** Department owner
- **Time to decide/approve permissions:** 5 minutes

### Removing Users
- **Users removed per month:** 3-5
...
### Password Resets
- **Password reset requests per week:** 1-2
- **Time per reset:** 2 minutes
- **Can users reset their own passwords?** Yes
...
|--------------|----------------|----------------------------|
| **Technical issues** (can't log in, errors, system down) | 1-2 | 2 min |
| **Business questions** ("how do I...", process questions) | 1-2 | 5-10 min |
| **Data questions** (where is data, why is this value X) | 0 | 0 min |
| **Report/export requests** | 0 | 0 min |
...
- Hardware (time terminal) connected
...
- **How many times did an integration break or have problems?** 
- **What typically breaks?** 
- **How do you discover it's broken?** 
- **Average time to fix integration issues:** 
- **Who do you contact for help with integrations?** 
...
|------------------|--------|-------------------|
| **Technical support tickets** (bugs, errors, system issues) | 2-3 | max 30 minutes |
| **Business/feature discussions** (how to use features, requests) | 1-2 | max 30 minutes |
| **Vendor meetings/calls** | 0 | 0 |

**Vendor responsiveness:** (Check one)
- [x] Good - usually responds quickly and helpful
...
- Setting up workflows, approval rules: 0 hours
- Configuring business settings: _____ hours
- Other configuration: _____ hours

### Reports & Data
**Time spent per week on:**
- Regular reports (weekly/monthly): 0 hours
- Ad-hoc data requests from users: _____ hours

**How many regular reports do you create/maintain?** 0 reports per month

### User Training
**Time spent on:**
- Training each new user (business processes): 1 hours per person
- Number of new users trained per year: 15-18
- Other training sessions per year: 0 hours

### Documentation
**Time spent per year on:**
- Creating/updating user guides: 0 hours
- Writing process documentation: 0 hours
