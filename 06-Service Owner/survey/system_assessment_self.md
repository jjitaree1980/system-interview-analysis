...
- Return completed form to: [Your name/email]
...
**Your department/team:** _____________________
...
**Primary purpose of this system:**
...
**Who else is involved in managing this system?**
_____________________
...
- [ ] Self-hosted - We have servers in our office/data center
- [ ] Not sure
- [ ] Other: _____
...
- **Main vendor contact person:** _____
...
| Activity | Hours per week | Examples/notes |
|----------|----------------|----------------|
| **Creating/removing user accounts** | _____ | Setting up new users, removing when people leave |
...
**Subtotal - User Management:** _____ hours/week
...
### Creating New Users
- **New user accounts per month:** _____
- **Time per account (technical setup):** _____ minutes
- **Who decides what access level new users need?** _____
- **Time to decide/approve permissions:** _____ minutes

### Removing Users
- **Users removed per month:** _____
- **How do you know when to remove someone?** _____
- **Time per removal:** _____ minutes

### Changing Permissions
- **Permission change requests per month:** _____
- **Time per change:** _____ minutes
- **Who decides permission levels?** _____

### Password Resets
- **Password reset requests per week:** _____
...
**How critical are these integrations?** (Check one)
- [ ] Very critical - business stops if integration is broken
- [ ] Important - causes significant problems if broken
- [ ] Nice to have - can work around if broken temporarily
- [ ] No integrations
...
**Who typically attends vendor meetings from your team?**
- _____
...
**How critical is this system to business operations?** (Check one)

- [ ] **5 - Critical** - Business cannot operate without it, need immediate fix if down
- [ ] **4 - Very important** - Major disruption if down, need fix within hours
- [ ] **3 - Important** - Causes problems if down, need fix within a day
- [ ] **2 - Useful** - Can work around if down temporarily
- [ ] **1 - Nice to have** - Minimal impact if down for a day or two
...
- **Time of day:** _____
- **Days of week:** _____
- **Times of month:** _____ (e.g., last 3 days of month, payroll days)
- **Times of year:** _____ (e.g., December year-end)

**During these critical times:**
- **Do you need to be available outside normal hours?** Yes / No
- **Have you been called nights/weekends in the last year?** _____ times

---

### If System Goes Down

**Maximum acceptable downtime:** _____ hours OR _____ minutes

**How many users would be affected?** _____

**What business processes would stop?** (Check all that apply)
- [ ] Cannot process orders
- [ ] Cannot ship products
- [ ] Cannot do payroll
- [ ] Cannot close month-end
- [ ] Cannot serve customers
- [ ] Safety/compliance issues
- [ ] Other: _____

**Business impact of downtime:** (Check all that apply)
- [ ] Direct revenue loss
...
**Are there any special requirements for this system?** (Check all that apply)
- [ ] Data retention requirements (keep data for X years)
- [ ] Audit requirements (must be able to show who did what)
- [ ] Regulatory reporting (must report to government/authorities)
- [ ] GDPR/privacy concerns (personal data)
- [ ] Financial compliance (accounting rules, SOX, etc.)
- [ ] Safety regulations
- [ ] None that I know of
- [ ] Other: _____
...
**What are your top 3 most time-consuming tasks with this system?**
1. _____
2. _____
3. _____

**What tasks take time but add least value?**
*(Repetitive, manual, frustrating tasks that seem unnecessary)*
- _____
- _____
...
*Rate each area: Would help a lot / Would help somewhat / Not needed / Not sure*

| Area | Would help a lot | Would help somewhat | Not needed | Not sure |
|------|------------------|---------------------|------------|----------|
| Automated monitoring/alerts for system health | [ ] | [ ] | [ ] | [ ] |
| Better backup verification | [ ] | [ ] | [ ] | [ ] |
| Help with system updates/patches | [ ] | [ ] | [ ] | [ ] |
| Password resets / user access management | [ ] | [ ] | [ ] | [ ] |
...
**Please explain your top 1-2 priorities for IT support:**
- _____
- _____

---

## SECTION 13: KNOWLEDGE & COVERAGE

### Current Documentation

**What documentation exists for this system?** 

*Rate quality: Good / Partial / Poor / None*

| Documentation Type | Good | Partial | Poor | None |
|-------------------|------|---------|------|------|
| Technical procedures (how to do technical tasks) | [ ] | [ ] | [ ] | [ ] |
| Business processes (how to use system for business) | [ ] | [ ] | [ ] | [ ] |
...
**If someone new needed to manage this system:**
- **What business knowledge would they need to know?** _____
- **What would be hardest to teach/hand over?** _____
- **How long would knowledge transfer take?** _____ hours/days/weeks
...
- **Can they handle everything you do?** Yes / No
- **What can't they do?** _____
...
*(For example, if IT handled more of the technical aspects)*
- _____
- _____
...
Thank you for completing this assessment. Your input is valuable for understanding our systems landscape and capacity planning.
